  <footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Copyright © 2018 Pinct Inc. All rights reserved.</p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://sujalpaudel.github.io">Sujal Puudel</a></span></p>
        </div>
      </div>
    </div>
